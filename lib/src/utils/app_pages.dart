...
import 'package:vimbika_pos_app/src/features/stock_requests/screen/transfer_history_screen.dart';
...
class AppPages {
  static final routes = [
    ...
    GetPage(
        name: AppRoutes.CHOOSE_BRANCH,
        page: () => const ChooseBranchScreen(),
        transition: Transition.zoom),
    GetPage(
        name: AppRoutes.ENTER_PIN,
        page: () => PinScreen(),
        transition: Transition.zoom),
    GetPage(
        name: AppRoutes.CART,
    ...
    GetPage(
        ...
        transition: Transition.zoom),
    GetPage(
        name: AppRoutes.SALE_RECEIPTS,
        page: () => ReceiptScreen(),
        transition: Transition.zoom),
    GetPage(
        name: AppRoutes.OPEN_SHIFT,
        page: () => OpenShiftScreen(),
        transition: Transition.zoom),
    GetPage(
    ...
    GetPage(
        ...
        transition: Transition.zoom),
    GetPage(
        name: AppRoutes.CASH_MANAGEMENT,
        page: () => CashManagementScreen(),
        transition: Transition.zoom),
    GetPage(
        name: AppRoutes.SUBMIT_CASH,
        page: () => SubmitCashScreen(),
        transition: Transition.zoom),
    GetPage(
    ...
    GetPage(
        ...
        transition: Transition.zoom),
    GetPage(
        name: AppRoutes.TICKET_FORM,
        page: () => TicketFormScreen(),
        transition: Transition.zoom),
    GetPage(
        name: AppRoutes.NETWORK_PRINTERS,
        page: () => NetworkPrintersScreen(),
        transition: Transition.zoom),
    GetPage(
        ...
        transition: Transition.zoom),
    GetPage(
        name: AppRoutes.DEFAULT_CURRENCY_SCREEN,
        page: () => DefaultCurrencyScreen(),
        transition: Transition.zoom),
    GetPage(
        name: AppRoutes.DEFAULT_PAYMENT_METHOD_SCREEN,
        page: () => DefaultPaymentMethodScreen(),
        transition: Transition.zoom),
    GetPage(
        name: AppRoutes.DEFAULT_FISCAL_SETTINGS,
    ...
    GetPage(
        ...
        transition: Transition.zoom),
    GetPage(
        name: AppRoutes.NEW_STOCK_REQUEST,
        page: () => NewStockRequestScreen(),
        transition: Transition.zoom),
    GetPage(
        name: AppRoutes.NEW_STOCK_REQUEST_CART,
        page: () => StockRequestCartScreen(),
        transition: Transition.zoom),
    GetPage(
        name: AppRoutes.TRANSFER_HISTORY_SCREEN,
        page: () => TransferHistoryScreen(),
        transition: Transition.zoom),
    GetPage(
        name: AppRoutes.REQUISITION_LIST_SCREEN,
        page: () => RequisitionListScreen(),
        transition: Transition.zoom),
    GetPage(
        name: AppRoutes.REQUISITION_HISTORY_SCREEN,
        page: () => RequisitionHistoryScreen(),
        transition: Transition.zoom),
    GetPage(
