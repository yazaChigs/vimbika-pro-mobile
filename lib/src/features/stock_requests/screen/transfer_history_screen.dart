        ...
        body: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: TextField(
                onChanged: (p) {
                  stockRequestController.filterItemsTransferHistory(p);
                },
            ...
            Expanded(
              child: Obx(() {
                return ListView.builder(
                  itemCount: stockRequestController.filteredTransferHistory.length,
                  itemBuilder: (context, index) {
                    var item = stockRequestController.filteredTransferHistory[index];
                    return Card(
