                ...
                GestureDetector(
                  ...
                  child: Padding(
                    ...
                    child: Icon(
                      ...
                      color: Colors.deepOrange, // Set ic
                      size: 30,// Set icon coloron color
                    ),
                  ),
                ),
              ],
                          ...
                          child: CupertinoButton(
                            ...
                            child: Container(   // wrap the text/widget using container
                              ...
                              child: Wrap(
                                ...
                                children: const [
                                  Icon(CupertinoIcons.search, color: Colors.indigo,size: 30,),
                                  Text(" Search item", style: TextStyle(color: Colors.indigo),)
                                ],
                              ),
                            ),
                            onPressed: () {
