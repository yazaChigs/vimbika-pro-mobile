          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                _buildInfoRow('Received From:', payment.payer.value?.name ?? 'N/A'),
                _buildInfoRow('Amount:', '${payment.currency.value?.symbol ?? ''} ${payment.amount.toStringAsFixed(2)}'),
                _buildInfoRow('Payment Method:', payment.paymentType.value?.name ?? 'N/A'),
                if (payment.bank.value != null) _buildInfoRow('Bank:', payment.bank.value!.name),
                const Divider(height: 30),
                const Text(
